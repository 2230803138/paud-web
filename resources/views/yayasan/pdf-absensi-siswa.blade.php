...
<head>
    <meta charset="utf-8">
    <title>Laporan Absensi Siswa - Ebony Preschool</title>
    <style>
        body {
...
<div class="header-section">
    ...
    <h4>LAPORAN ABSENSI HARIAN SISWA</h4>
    <hr>
</div>
...
<div class="info-filter">
    ...
    Kelas Absensi: {{ $kelasAbsensi ?? 'Semua Kelas' }}
</div>
...
<table>
    ...
    <tbody>
        ...
        @empty
            <tr>
                <td colspan="5" class="text-center" style="padding: 15px;">Belum ada riwayat absensi siswa pada periode ini.</td>
            </tr>
        @endforelse
    </tbody>
</table>
